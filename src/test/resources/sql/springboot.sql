...
CREATE TABLE `role_permission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `role_permission` VALUES (72,2,'/system'),(73,2,'/user/role/list'),(74,2,'/user/role/detail'),(76,2,'/user/role/add');
...
INSERT INTO `user_role` VALUES (1,'0','管理员',0,50),(2,'0','产品管理员',0,56),(3,'0','66666666',1,0),(4,'0','1231231',1,0),(5,'0','1312313123',1,4),(6,'0','6666666666666666',1,0),(7,'0','踩踩踩踩踩踩5xxx',0,0);
...
-- Dump completed on 2018-08-11 10:15:03
