...
CREATE TABLE `union_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='组织的一些配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-24 18:15:01
