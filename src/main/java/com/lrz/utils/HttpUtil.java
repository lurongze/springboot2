...
public class HttpUtil {
	...
	private static final String USERAGENT_IE = "Mozilla/5.0 (Windows NT 6.3; WOW64; Trident/7.0; rv:11.0) like Gecko";
    ...
    public static StringBuffer httpRequest(String requestUrl, String requestMethod, String output) throws IOException {
        URL url = new URL(requestUrl);
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        connection.setDoOutput(true);
        connection.setDoInput(true);
        connection.setUseCaches(false);
        connection.setConnectTimeout(60000);//10s超时
	...
	private HttpResult doGet(String url, Map<String, String> headers, Map<String, String> params) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException, ClientProtocolException, IOException {
	...
	public static HttpResult httpDoPost(String url, Map<String, String> headers, Map<String, String> postData, String encoding) throws Exception {
		return new HttpUtil().doPost(url, headers, postData, encoding);
	}

	public static HttpResult httpDoGet(String url, Map<String, String> headers, Map<String, String> params) throws Exception {
		return new HttpUtil().doGet(url, headers, params);
	}

	private HttpResult doPost(String url, Map<String, String> headers, Map<String, String> postData, String encoding) throws Exception {
